...
* [x] 阶段2 细化：规则、私房、账号/云存盘、作品管理 + **完整节点系统（319 全量）+ 落地开工计划（M0→M5）**

* [x] **M0 节点基建**：解析 `zmcs/NodeDoc.xml`（319，含39过时）→ 生成节点全集清单 + 节点→引擎全量映射表（Tier1=101/ Tier2=119/ Tier3=60）

* [ ] **M1 待核收尾**：引擎侧人工复核映射表中 67 条「△待核」归属 → 敲定 Tier1 开工批次
